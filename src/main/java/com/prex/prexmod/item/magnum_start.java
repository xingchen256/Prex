...
public class magnum_start extends ItemPE implements IItemEmc {
    @SideOnly(Side.CLIENT)
    private IIcon[] icons;
    private double[] MAX_MAGNUM_EMC = new double[]{204_800_000,
            819_200_000,3_276_800_000f,13_107_200_000f,
            52_428_800_000f,209_715_200_000f};

    public magnum_start()
    {
        this.setCreativeTab(PREX_TAB);
//        this.setTextureName("prex:star/magnum/");
        this.setUnlocalizedName("magnum_star");
        this.setMaxDamage(0);
...
//                EMCHelper.getKleinStarMaxEmc(stack);
    }
    ...
    public void registerIcons(IIconRegister register)
    {
        ...
        for (int i = 0; i < 6; i++)
        {
            icons[i] = register.registerIcon("prex:star/magnum/"+ "magnum_star_"+(i + 1));
        }
    }
