...
public class gargantuan_star extends ItemPE implements IItemEmc {
    @SideOnly(Side.CLIENT)
    private IIcon[] icons;
    private double[] MAX_MAGNUM_EMC = new double[]{34359738000_00000f,
            137438953_00000000f,549755813_00000000f,2199023255_00000000f,
            8796093022208_00000000f,35184372088_00000000f};

    public gargantuan_star()
    {
        this.setCreativeTab(PREX_TAB);
        this.setUnlocalizedName("gargantuan_star");
        this.setMaxDamage(0);
    ...
    public void registerIcons(IIconRegister register)
    {
        ...
        for (int i = 0; i < 6; i++)
        {
            icons[i] = register.registerIcon("prex:star/gargantuan/"+ "s"+(i + 1));
        }
    }
